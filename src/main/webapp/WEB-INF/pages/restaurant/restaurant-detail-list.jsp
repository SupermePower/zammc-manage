    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">店家详情信息</h3>
                        <a class="btn btn-info" href="${ctx}/manage/restaurantDetail/toAdd">
                            新增
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <c:forEach var="restaurantDetail" items="${ page.content}" varStatus="in">
                                    <tr>
                                        <td class="center">
                                            <label>
                                                <input type="checkbox" class="ace"/>
                                        ...
                                        <td>${restaurantDetail.restaurantProperty}</td>
                                        <td><img class="img-data" src="${restaurantDetail.propertyImg}" alt=""></td>
                                        <td class="hidden-480">${restaurantDetail.propertyMsg}</td>
                                        <td class="hidden-480">
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <a class="btn btn-xs btn-danger deleteRestaurantDetail"
                                                   data="${restaurantDetail.id}" url="/manage/restaurantDetail/deleteRestaurantDetail">
                                                    <i class="icon-trash bigger-120">删除</i>
                                                </a>
                                                <a class="btn btn-xs btn-primary no-radius"
                                                   href="/manage/restaurantDetail/toEdit?restaurantId=${restaurantDetail.id}">
...
<script type="text/javascript" src="${rootURL}resources/js/restaurant/restaurant-detail-list.js"></script>
</html>