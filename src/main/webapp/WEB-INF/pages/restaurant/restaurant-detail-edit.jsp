    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">编辑店家详情信息</h3>
                        <form class="form-horizontal edit-restaurant-form" action="${ctx}/manage/restaurant/editRestaurant" method="post"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 店家详情名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="restaurantName" value="${restaurantProperty.restaurantName}" placeholder="店家详情名称"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 店家详情顺序 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" name="restaurantCode" value="${restaurantProperty.restaurantCode}" placeholder="店家详情顺序"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" id="dropzone">
                                    <input type="hidden" value="${restaurantProperty.restaurantImg}" name="restaurantImg" />
