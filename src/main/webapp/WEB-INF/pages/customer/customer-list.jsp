    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">顾客列表</h3>
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <c:forEach var="customer" items="${ page.content}" varStatus="in">
                                        <tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace"/>
...
<script type="text/javascript" src="${rootURL}resources/js/customer/customer-list.js"></script>
</html>