            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-userId-photo" src="assets/avatars/userId.jpg" alt="Jason's Photo"/>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main no-padding">
                                            <div class="dialogs">
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    <div class="userId">
                                                        <img alt="Bob's Avatar" src="assets/avatars/userId.jpg"/>
                                                    </div>
                                    ...
                                    <div class="widget-header">
                                        ...
                                        <div class="widget-toolbar no-border">
                                            <ul class="nav nav-tabs" id="recent-tab">
                                                <li class="active">
                                                    <a data-toggle="tab" href="#task-tab">待付款</a>
                                                </li>

                                                <li>
                                                    <a data-toggle="tab" href="#member-tab">已付款</a>
                                                </li>

                                                <li>
                                                    <a data-toggle="tab" href="#comment-tab">已取消</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
