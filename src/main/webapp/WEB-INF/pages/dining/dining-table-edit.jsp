    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">编辑餐位</h3>
                        <form class="form-horizontal edit-dining-table-form" action="${ctx}/manage/diningTable/editDiningTable" method="post"
                              enctype="multipart/form-data" role="form">
                            <input type="hidden", name="tableId" value="${diningTable.tableId}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 餐位名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="tableCode" placeholder="餐位名称" value="${diningTable.tableCode}"
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" id="editDiningTable" type="button">
...
<script type="text/javascript" src="${rootURL}resources/js/dining/dining-table-edit.js"></script>
