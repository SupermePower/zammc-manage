    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">编辑充值套餐</h3>
                        <form class="form-horizontal edit-recharge-package-form" action="${ctx}/manage/rechargePackage/editRechargePackage" method="post"
                              enctype="multipart/form-data" role="form">
                            <input type="hidden" name="packageId" value="${rechargePackage.packageId}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 套餐名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="packageName" value="${rechargePackage.packageName}" placeholder="套餐名称"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 充值金额 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" name="rechargeMoney" value="${rechargePackage.rechargeMoney}" placeholder="充值金额"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="goodsType" name="payMoney" value="${rechargePackage.payMoney}" placeholder="支付金额"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" id="editRechargePackage" type="button">
...
<script type="text/javascript" src="${rootURL}resources/js/recharge/recharge-package-edit.js"></script>
