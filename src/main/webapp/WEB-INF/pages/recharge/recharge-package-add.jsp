    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">新增充值套餐</h3>
                        <form class="form-horizontal add-recharge-package-form" action="${ctx}/manage/rechargePackage/addRechargePackage" method="post"
                              enctype="multipart/form-data" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 套餐名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="packageName" placeholder="套餐名称"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" name="rechargeMoney" placeholder="充值金额"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="goodsType" name="payMoney" placeholder="支付金额"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" id="addRechargePackage" type="button">
...
<script type="text/javascript" src="${rootURL}resources/js/recharge/recharge-package-add.js"></script>
