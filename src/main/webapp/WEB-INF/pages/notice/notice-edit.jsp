            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal edit-notice-form" action="${ctx}/manage/banner/editBanner" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="bannerName" value="${notice.noticeName}" placeholder="公告名称"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="form-field-2" name="noticceSort" value="${notice.noticceSort}" placeholder="公告显示顺序"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
