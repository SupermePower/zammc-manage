            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal add-notice-form" action="${ctx}/manage/notice/addNotice" method="post"
                              enctype="multipart/form-data" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 公告名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="noticeName" placeholder="公告名称"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="form-field-2" name="noticeSort" placeholder="公告显示顺序"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" id="addNotice" type="button">
...
<script type="text/javascript" src="${rootURL}resources/js/notice/notice-add.js"></script>
