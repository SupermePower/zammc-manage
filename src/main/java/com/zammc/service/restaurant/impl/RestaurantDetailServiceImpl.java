...
public class RestaurantDetailServiceImpl implements RestaurantDetailService {
     ...
     * @throws Exception
     */
    public void queryRestaurantDetailPage(RestaurantPropertyEntity restaurantPropertyEntity, PageBean pageBean) throws Exception {
     ...
     * @throws Exception
     */
    public Message addRestaurantDetail(RestaurantPropertyEntity restaurantPropertyEntity, HttpServletRequest request) throws Exception {
     ...
     * @throws Exception
     */
    public RestaurantPropertyEntity queryRestaurantPropertyById(RestaurantPropertyEntity restaurantPropertyEntity) throws Exception {
     ...
     * @return
     */
    private boolean checkPropertyImg(RestaurantPropertyEntity restaurantPropertyEntity, MultipartFile image) {
        if (image == null) {
            return true;
        } else {
            String img = "";
