...
public class ActivityServiceImpl implements ActivityService {
     ...
     */
    @Override
    public void queryActivityPage(ActivityEntity activityEntity, PageBean pageBean) throws Exception {
     ...
     */
    @Override
    public Message deleteActivity(ActivityEntity activityEntity) throws Exception {
     ...
     */
    @Override
    public Message addActivity(ActivityEntity activityEntity) throws Exception {
     ...
     */
    @Override
    public Message startUsing(ActivityEntity activityEntity) throws Exception {
        ActivityEntity one = activityRepository.findOne(activityEntity.getActivityId());
     ...
     */
    @Override
    public Message forbidden(ActivityEntity activityEntity) throws Exception {
        ActivityEntity one = activityRepository.findOne(activityEntity.getActivityId());
